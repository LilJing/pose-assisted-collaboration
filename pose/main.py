...
parser.add_argument('--workers', type=int, default=10, metavar='W', help='how many training processes to use (default: 32)')
parser.add_argument('--num-steps', type=int, default=20, metavar='NS', help='number of forward steps in A3C (default: 300)')
parser.add_argument('--test-eps', type=int, default=100, metavar='M', help='maximum length of an episode (default: 10000)')
...
parser.add_argument('--model', default='gru-discrete', metavar='M', help='Model type to use') 
parser.add_argument('--gpu-ids', type=int, default=-1, nargs='+', help='GPUs to use [-1 CPU only] (default: -1)')
parser.add_argument('--obs', default='none', metavar='UE', help='unreal env')
